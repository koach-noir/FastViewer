...
- 事前読み込みエンコードにより多少改善したが画像ファイルサイズが大きいものはまだ遅い
− ４スレッド機能の見直し含め改善可能性調査

### 画像読み込み、表示の機能とそれ以外の機能で疎な実装になっているか

- リファクタリングのタイミングかもしれない
- 気になるのは根幹機能の「画像高速ビューイング」とそれに付随する根幹以外の機能「UI/UX」が分離している方が望ましい
